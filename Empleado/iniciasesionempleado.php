	...
	<div class="mainheading">
		...
		<div class="centro">
            <main>
                <section>
                     <header>
					Para visualizar los precios y poder realizar alg&uacute;na modificación es necesario que inicie sesión empleado
                    <br/>
					Si usted no es empleado, por favor vuelva a la página anterior
					<br/><br/><br/>
					<form action="modDB/validarempleado.php" method= "post" >
