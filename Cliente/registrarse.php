...
?>
    ...
    <h1>Ingrese sus datos</h1>
                                <form action="modDB/guardaregistro.php" method="POST"  enctype= "multipart/form-data">
                                    ...
                                    <input type="submit" class="btn btn-primary"> <a href="../index.php"class="btn btn-info">Regresar</a><br>
